...
public interface CandidatosRepository extends JpaRepository<Candidatos, Long> {
    ...
    Optional<Candidatos> findTopByOrderByDataDaAtualizacaoAsc();
     ...
     // Método para buscar por prontuário e filtrar candidatos com trabalha igual a "sim"
    ...
    // Consulta para agrupar os valores de funcao e contar quantas vezes cada um aparece (ignorando nulos)
